...
def test_c2_summary():
    ...
    df4.to_csv(file_c2, index = False)
...
# output
file_c1 = join(dirname(tab_s1.__file__), 'd',
                'd1-simul-results_part2.json')

file_c2 = join(dirname(tab_s1.__file__), 'd',
                'd2-simul-results-summary_part2.csv')

file_c2_plot_a = join(dirname(tab_s1.__file__), 'd',
                    'd2-simul-results-summary_part2')

#file_c2_plot_b = join(dirname(tab_s1.__file__), 'd',
