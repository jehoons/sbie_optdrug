...
pert_no.scatter(no_pert, marker='s', color='blue', label="GFs = 0, TNFalpha = 0")
...
pert_sing.scatter(sing_pert, marker='s', color='blue', label="GFs = 0, TNFalpha = 0")
...
pert_doub.scatter(doub_pert, marker='s', color='blue', label="GFs = 0, TNFalpha = 0")
